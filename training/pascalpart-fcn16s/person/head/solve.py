...
if not os.path.exists(snapshot):
    ...
    os.symlink('{}/pascalpart-fcn16s/person/{}/{}'.format(models, part, snapshot), snapshot)
...
if is_resume:
    ...
    solver.net.copy_from('../../../pascalpart-fcn32s/person/{}/snapshot/train_iter_52000.caffemodel'.format(part))
...
seg_results = '{}/models/pascalpart-fcn16s/person/{}/segmentation_results'.format(caffe_root, part)
for _ in range(10):
    solver.step(8000)
