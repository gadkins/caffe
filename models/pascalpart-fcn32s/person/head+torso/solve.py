...
if not os.path.exists(snapshot):
    ...
    os.symlink('{}/training/pascalpart-fcn32s/person/{}/{}'.format(caffe_root, part, snapshot), snapshot)

loss = 'loss'
if not os.path.exists(loss):
    print 'Creating loss directory...\n'
    os.symlink('{}/training/pascalpart-fcn32s/person/{}/{}'.format(caffe_root, part, loss), loss)

if not os.path.exists(log):
    print 'Creating training_log directory...\n'
    os.symlink('{}/training/pascalpart-fcn32s/person/{}/{}'.format(caffe_root, part, log), log)
