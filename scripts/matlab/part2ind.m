...
% pimap{15}('hair')       = 1;           
% 
% pimap{15}('torso')      = 2;                    % torso
% pimap{15}('neck')       = 2;  

pimap{15}('head')       = 3;                    % head+torso
pimap{15}('leye')       = 3;                    
pimap{15}('reye')       = 3;                      
pimap{15}('lear')       = 3;                    
pimap{15}('rear')       = 3;                    
...
% pimap{15}('llarm')      = 4;                   % left arm
% pimap{15}('luarm')      = 4;                   
% pimap{15}('lhand')      = 4;                   
% 
% pimap{15}('rlarm')      = 5;                   % right arm
% pimap{15}('ruarm')      = 5;                  
% pimap{15}('rhand')      = 5;                  
% 
% pimap{15}('llarm')      = 6;                   % left & right arms (arms)
% pimap{15}('luarm')      = 6;                   
% pimap{15}('lhand')      = 6;                   
% pimap{15}('rlarm')      = 6;                   
% pimap{15}('ruarm')      = 6;                   
% pimap{15}('rhand')      = 6;                  
% 
% pimap{15}('llleg')      = 7;               	% left leg
% pimap{15}('luleg')      = 7;               	
% pimap{15}('lfoot')      = 7;               	
% 
% pimap{15}('rlleg')      = 8;               	% right leg
% pimap{15}('ruleg')      = 8;           
% pimap{15}('rfoot')      = 8;             
% 
% pimap{15}('llleg')      = 9;               	% left & right legs (legs)
% pimap{15}('luleg')      = 9;               	
% pimap{15}('lfoot')      = 9;               	
% pimap{15}('rlleg')      = 9;               	
% pimap{15}('ruleg')      = 9;               	
